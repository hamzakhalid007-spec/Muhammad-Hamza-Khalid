...
public class Player extends Entity {
    ...
    public void setDefaultValues(){
        ...
        mana = maxMana;
        ammo = 10;
        strength = 1; //More strength means more damage
        dexterity = 1; //More dexterity means more defense
        exp = 0;
        nextLevelExp = 5;
        coin = 150;
        currentWeapon = new OBJ_Sword_Normal(gp); //Total attack determined by strength and weapon
        currentShield = new OBJ_Shield_Wood(gp); // Total defense determined by dexterity and shield
    ...
    public void getPlayerAttackImage(){
        ...
        attackUp1 = setup("/res/player/axe_up_1", gp.tileSize, gp.tileSize*2);
        attackUp2 = setup("/res/player/axe_up_2", gp.tileSize, gp.tileSize*2);
        attackDown1 = setup("/res/player/axe_down_1", gp.tileSize, gp.tileSize*2);
        attackDown2 = setup("/res/player/axe_down_2", gp.tileSize, gp.tileSize*2);
        attackLeft1 = setup("/res/player/axe_left_1", gp.tileSize*2, gp.tileSize);
        attackLeft2 = setup("/res/player/axe_left_2", gp.tileSize*2, gp.tileSize);
        attackRight1 = setup("/res/player/axe_right_1", gp.tileSize*2, gp.tileSize);
        attackRight2 = setup("/res/player/axe_right_2", gp.tileSize*2, gp.tileSize);
        }
    }
    ...
    public void update(){
        ...
        if(gp.keyH.shotKeyPressed == true && projectile.alive == false && shotAvailableCounter == 30 
            ...
            //Set project coordinates, direction and user
        ...
        if (i != 999) {
            ...
            //Inventory items
                ...
                if(inventory.size() != maxInventorySize){
                    ...
                    text = "Your inventory is full! Cannot pick anymore objects.";
                }
