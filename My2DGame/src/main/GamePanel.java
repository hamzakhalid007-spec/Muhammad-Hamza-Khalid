...
public class GamePanel extends JPanel implements Runnable {
    //screen settings
    final int originalTextSize = 16; // 16x16 tile
    final int scale = 3;
    public final int tileSize = originalTextSize * scale; // 48x48 tile
    ...
    public void setFullScreen(){
        //Get local screen of device
        GraphicsEnvironment ge = GraphicsEnvironment.getLocalGraphicsEnvironment();
        GraphicsDevice gd = ge.getDefaultScreenDevice();
        gd.setFullScreenWindow(TwoDGame.window);
        //Get full width and height
        screenWidth2 = TwoDGame.window.getWidth();
        screenHeight2 = TwoDGame.window.getHeight();
    }
