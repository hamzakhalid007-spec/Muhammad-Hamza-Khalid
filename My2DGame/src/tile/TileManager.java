...
public class TileManager {
    ...
    public void setup(int index, String imagePath, boolean collision) {
        ...
        try {
            tile[index] = new Tile();
            InputStream is = getClass().getResourceAsStream("/res/tiles/" + imagePath + ".png");
            if (is == null) {
                throw new IOException("Tile image not found: /res/tiles/" + imagePath + ".png");
            }
        ...
        while (worldCol < gp.maxWorldCol && worldRow < gp.maxWorldRow){
            ...
            if (worldX > gp.player.worldX - gp.player.screenX - gp.tileSize &&
                ...
                if (tileNum >= 0 && tileNum < tile.length && tile[tileNum] != null) {
                    ...
                    System.err.println("Warning: tileNum " + tileNum + " is invalid at (" + worldCol + ", " + worldRow + ")");
                }
            }
